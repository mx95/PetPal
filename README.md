...
- **Web app**: `petpal/`
- **Tracker backend (TCP + HTTP + SQLite)**: `tracker-tcp-server/`

Start here:

- **Local dev**: see `petpal/README.md`
...
- **Android & iOS apps (separate GitLab repos)**: see [`docs/MOBILE_GITLAB.md`](docs/MOBILE_GITLAB.md)

...
export const ActivityHub = lazyWithRetry(() => import('./routes/activityRoute'));
export const Profile = lazyWithRetry(() => import('./routes/profileRoute'));
...
export const LostPetAlerts = lazyWithRetry(() => import('./routes/lostPetAlertsRoute'));
...
export const Community = lazyWithRetry(() => import('./routes/communityRoute'));
export const Leaderboard = lazyWithRetry(() => import('./routes/leaderboardRoute'));

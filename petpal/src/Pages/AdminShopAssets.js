...
export default function AdminShopAssets() {
  ...
  return (
    <div className="pp-pad">
      ...
      <p className="pp-subtle">{t('adminShopAssets.sub')}</p>
      ...
      <section className="pp-card pp-pad pp-adminShopAssets" style={{ marginTop: 16 }}>
        <div className="pp-row" style={{ justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      <div className="pp-row" style={{ gap: 10, marginTop: 16, flexWrap: 'wrap' }}>
        <button
          type="button"

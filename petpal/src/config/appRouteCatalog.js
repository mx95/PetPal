...
export const APP_ROUTE_CATALOG = [
  ...
  { path: '/bookings', labelKey: 'docs.route.bookings.label', descKey: 'docs.route.bookings.desc', auth: 'auth', mvpNav: false },
  { path: '/bookings/provider/:providerId', labelKey: 'docs.route.providerProfile.label', descKey: 'docs.route.providerProfile.desc', auth: 'auth', mvpNav: false },
  { path: '/bookings/provider/:providerId/book/:serviceId', labelKey: 'docs.route.bookService.label', descKey: 'docs.route.bookService.desc', auth: 'auth', mvpNav: false },

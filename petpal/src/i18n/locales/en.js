export default {
  ...
  docs: {
    ...
    pageSubtitle:
      'A short guide for pet owners: account, pets, walks, community, maps, stray adoption board, optional GPS collar, and privacy links.',
    backApp: '← Dashboard',
    backLogin: '← Log in',
    ...
    u2Body:
      'Tap Register to create an account with your email and a password. Already have an account? Use Log in.\n\nAfter you sign in, the top bar lists Dashboard, Pets, Lost pet, Stray adoption, Community, Leaderboard, Nearby, Tracker, and Business (when available). Your selected language is remembered on this device.',
    u3Title: 'Your pets',
    u3Body:
    ...
    u10Body:
      'Open Stray adoption to post animals you found as strays (not your own missing pet—that flow stays under Lost pet). Shelters and adopters who use PetPal see the same board; contact finders by phone or email shown on each card.\n\nAfter Firebase is configured, listings sync for everyone. Mark your own post as adopted when homed, or withdraw it when no longer needed.',

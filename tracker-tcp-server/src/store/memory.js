function createMemoryStore() {
  // This store is intentionally memory-only and used for:
  // - command queues (0x21)
  // - per-IMEI sequence numbers
  // - active sockets for sending commands
  //
  // Device state and history are persisted in SQLite via src/db.js.

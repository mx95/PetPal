...
deploy_firebase_functions() {
  ...
  cd "$PETPAL_DIR"
  if $fb deploy \
    --only functions:createJccCheckout,functions:createJccUpdateCard,functions:jccPaymentReturn,functions:billingRenewal,functions:expireProviderBoosts,functions:assignSubscriptionImei,functions:linkTrackerSubscriptionPet,functions:adminAssignPetTrackingDevice,functions:adminExtendSubscriptionFreeMonths,functions:createCustomerBooking,functions:sendBookingConfirmation,functions:submitContactForm,functions:getSupportEmailStatus,functions:saveSupportSmtpConfig,functions:uploadShopAsset,functions:refreshNearbyPlacesCache,functions:bootstrapRefreshNearbyPlacesCache,functions:getNearbyPlacesCacheMeta \
